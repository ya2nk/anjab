...
<div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Data Master Temperamen Kerja</h2>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">Form Temperamen kerja</h4>
				</div>
...
<script>
	...
	{
		$('.modal-body').html('');
		$.post('<?= site_url('temperamen/form'); ?>',{id:id}).done(function(result){
	...
	{
		$_confirm(function(){
			$.post('<?= site_url('temperamen/delete'); ?>',{id:id},function(result){
				if (result == 'success'){
