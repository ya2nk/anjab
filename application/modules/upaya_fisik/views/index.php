		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">Form Minat kerja</h4>
				</div>
...
<script>
	...
	{
		$('.modal-body').html('');
		$.post('<?= site_url('upaya_fisik/form'); ?>',{id:id}).done(function(result){
	...
	{
		$_confirm(function(){
			$.post('<?= site_url('upaya_fisik/delete'); ?>',{id:id},function(result){
				if (result == 'success'){
