...
<script>
	...
	{
		$('.modal-body').html('');
		$.post('<?= site_url('minat/form'); ?>',{id:id}).done(function(result){
	...
	{
		$_confirm(function(){
			$.post('<?= site_url('minat/delete'); ?>',{id:id},function(result){
				if (result == 'success'){
