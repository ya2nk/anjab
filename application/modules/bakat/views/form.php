<form id="fm" class="form-horizontal form-label-left">
	...
	<div class="form-group">
        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Nama Bakat <span class="required">*</span>
        </label>
        <div class="col-md-6 col-sm-6 col-xs-12">
			<?= input_text('bakat',['class'=>'form-control col-md-12 col-xs-12'],@$row->bakat); ?>
		</div>
    </div>
	<div class="form-group">
...
<script>
	...
	{
		if(form.valid()){
			$.post('<?= site_url('bakat/save'); ?>',form.serialize()).done(function(result){
				if (result == 'success'){
