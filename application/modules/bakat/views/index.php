...
<script>
	...
	{
		$('.modal-body').html('');
		$.post('<?= site_url('bakat/form'); ?>',{id:id}).done(function(result){
	...
	{
		$_confirm(function(){
			$.post('<?= site_url('bakat/delete'); ?>',{id:id},function(result){
				if (result == 'success'){
