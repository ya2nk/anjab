...
<div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Data Master Fungsi Fisik</h2>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">Form Fungsi Fisik</h4>
				</div>
...
<script>
	$(function(){
		table = $('#myTable').DataTable({
			...
			"serverSide": true,
			"ajax": {
				"url": "<?= site_url('fungsi_fisik/data'); ?>",
				"type":"POST",
				"data": function ( d ) {
					d.myKey = "myValue";
	...
	{
		$('.modal-body').html('');
		$.post('<?= site_url('fungsi_fisik/form'); ?>',{id:id}).done(function(result){
	...
	{
		$_confirm(function(){
			$.post('<?= site_url('fungsi_fisik/delete'); ?>',{id:id},function(result){
				if (result == 'success'){
