...
<button class="btn btn-primary no-print" onclick="window.print()">CETAK</button>
 ...
 <center><h4>INFORMASI JABATAN</h4></center>
	<table class="table">
					<tr>
						<th width="4%">1.</th>
						...
						<td>
							<table class="table table-bordered">
								<tr>
									...
									<th>Waktu Penyelesain (Jam)</th>
									<th>Waktu Efektif Penyelesain</th>
					...
					<tr>
						...
						<td>
							<table class="table table-bordered">
								...
								<?php $korelasi = json_decode($row->korelasi_jabatan); if(is_countable($korelasi) >0) : foreach($korelasi as $k=>$ko) : if ($ko->korelasi_jabatan == '') continue; ?>
								<tr>
									<td><?= $k+1; ?></td>
					...
					<tr>
						...
						<td>
							<table>
								...
								<?php $keterampilan = json_decode($row->keterampilan_kerja); if(is_array($keterampilan)) : if(is_countable($keterampilan) >0) : foreach($keterampilan as $k=>$ke) : ?>
								<tr>
									<td><?= $abjad[$k]; ?>.&nbsp;</td>
					...
					<tr>
						...
						<td>
							<table>
								...
								<?php $bakat = json_decode($row->bakat_kerja); if(is_array($bakat)) : if(is_countable($bakat) >0) : foreach($bakat as $k=>$ba) : ?>
								<tr>
									<td><?= $abjad[$k]; ?>.&nbsp;</td>
					...
					<tr>
						...
						<td>
							<table>
								...
								<?php $temperamen = json_decode($row->temperamen_kerja); if(is_array($temperamen)) : if(is_countable($temperamen) >0) : foreach($temperamen as $k=>$te) : ?>
								<tr>
									<td><?= $abjad[$k]; ?>.&nbsp;</td>
					...
					<tr>
						...
						<td>
							<table>
								...
								<?php $minat = json_decode($row->minat_kerja); if(is_array($minat)) : if(is_countable($minat) >0) : foreach($minat as $k=>$mi) : ?>
								<tr>
									<td><?= $abjad[$k]; ?>.&nbsp;</td>
					...
					<tr>
						...
						<td>
							<table>
								...
								<?php $upaya = json_decode($row->upaya_fisik); if(is_array($upaya)) : if(is_countable($upaya) >0) : foreach($upaya as $k=>$up) : ?>
								<tr>
									<td><?= $abjad[$k]; ?>.&nbsp;</td>
